...
public class PdfService {
    ...
    public byte[] genererRecuPaiementEtSauvegarder(PaiementDto paiement) throws Exception {
        String dossier = "Recu/";
        Files.createDirectories(Paths.get(dossier));
        ...
        tableHeader.setWidthPercentage(100);
        tableHeader.setWidths(new float[]{1.5f, 4f});
        ...
        tablePaiement.addCell(getCell("Montant payé :", PdfPCell.ALIGN_LEFT));
        tablePaiement.addCell(getCell(paiement.getMontantActuel() + " " + config.getDevise(), PdfPCell.ALIGN_LEFT));
        ...
        // Retourne le PDF en bytes pour l'envoyer au frontend
